---
title: Rate Limiter
description: Design and implementation of a scalable rate limiter system, including algorithms, trade-offs, and architecture decisions.
tags: ["System Design"]
pubDate: 2026-04-09
heroImage: ../../assets/blogs/rate-limit.png
---
...
Non funcational requiremnt - how will it be able to it ? - scalability , durability, security , low latency, fault tolerant - not write it down, just think about it before designing your system
...
how do you knwo this user is unique 1. userId in query / jwt 2. ip 3. API key
